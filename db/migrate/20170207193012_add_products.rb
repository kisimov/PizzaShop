class AddProducts < ActiveRecord::Migration[5.0]
  def change
	...
	Product.create :title => 'Pepperoni', :description => 'Nice Pepperoni pizza', :price => 400, :size => 30, :is_spicy => false, :is_veg => false, :is_best_offer => false, :path_to_image => '/images/pepperoni.jpg' 
